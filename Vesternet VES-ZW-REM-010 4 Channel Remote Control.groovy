...
metadata {
	definition (name: "Vesternet VES-ZW-REM-010 4 Channel Remote Control", namespace: "Vesternet", author: "Vesternet", mcdSync: true, ocfDeviceType: "x.com.st.d.remotecontroller", mnmn: "Sunricher", vid: "generic-12-button") {
		capability "Button"
		capability "Sensor"
		capability "Battery"

		fingerprint mfr: "0330", prod: "0300", model: "B302", deviceJoinName: "Vesternet VES-ZW-REM-010 4 Channel Remote Control"		
	}
    preferences {		
...
def addChildButtons(numberOfButtons) {
	...
	for (def endpoint : 1..numberOfButtons) {
		try {
			...
			def child = addChildDevice("Vesternet", "Vesternet VES-ZW-REM-010 4 Channel Remote Control Child Button", childDni, device.getHub().getId(), [
					completedSetup: true,
